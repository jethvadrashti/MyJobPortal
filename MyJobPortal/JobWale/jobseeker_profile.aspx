<%@ Page Title="" Language="C#" MasterPageFile="~/jobseekermaster.master" Debug ="true" AutoEventWireup="true" CodeFile="jobseeker_profile.aspx.cs" Inherits="jobseeker_profile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" 
        ForeColor="#FF3300" Text="" Font-Underline="True"></asp:Label>
<div class="w3-container w3-green">
<center>
 <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" 
        ForeColor="#FF3300" Text="Basic Details" Font-Underline="True"></asp:Label>

   <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            DataKeyNames="candidate_id" DataSourceID="SqlDataSource1" Height="91px" 
            style="margin-left: 90px" Width="302px">
            <Fields>
                ...
                <asp:BoundField DataField="que_id" HeaderText="que_id" SortExpression="que_id" Visible="False" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="Data Source=DELL-PC;Initial Catalog=jobwale;Integrated Security=True" 
...
<asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" 
        ForeColor="#FF3300" Text="Educational Details" Font-Underline="True"></asp:Label>
   <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" 
            DataKeyNames="candidate_edu_id" DataSourceID="SqlDataSource2" Height="50px" 
            style="margin-left: 100px" Width="341px">
            <Fields>
...
<asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" 
        ForeColor="#FF3300" Text="Professional Details" Font-Underline="True"></asp:Label>
    <asp:DetailsView ID="DetailsView3" runat="server" AutoGenerateRows="False" 
            DataKeyNames="candidate_prof_id" DataSourceID="SqlDataSource3" Height="56px" 
            style="margin-left: 94px" Width="326px">
            <Fields>
